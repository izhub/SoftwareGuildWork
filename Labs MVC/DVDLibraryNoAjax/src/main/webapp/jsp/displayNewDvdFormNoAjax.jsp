    ...
    <body>
        <div class="container"> 
            ...
            <sf:form class="form-horizontal" role="form" action="addnew" 
                     modelAttribute="dvd" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <sf:input name="mpaaRating" type="text"
                               class="form-control"
                               id="add-rating"
                               path="mpaaRating"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <sf:input name="director" type="text"
                               class="form-control"
                               id="add-director"
                               path="director"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <sf:input name="releaseDate" type="date"
                               class="form-control"
                               id="add-release-date"
                               path="releaseDate"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <sf:input name="studio" type="text"
                               class="form-control"
                               id="add-studio"
                               path="studio"
                               placeholder="Studio"/>
