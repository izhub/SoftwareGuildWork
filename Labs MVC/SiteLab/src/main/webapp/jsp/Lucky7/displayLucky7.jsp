        ...
        <div class="container">
            ...
            <div class="navbar">
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation"class="active"> <a href="${pageContext.request.contextPath}/Lucky7/displayLucky7">Lucky Sevens</a></li>
            ...
            <h2>Let's play Lucky 7!!! </h2>
            <form action="submitLucky7" method="POST">
