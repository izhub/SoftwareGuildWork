        ...
        <div class="container">
            ...
            <div class="navbar">
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation"class="active"> <a href="${pageContext.request.contextPath}/InterestCalculator/displayInterestCalc">Interest Calculator</a></li>
            ...
            ${results}
        <!--     Beginning balance: ${userPrincipal}
            Interested Earned: ${iEarned}
            Current Balance: ${cBal}
            ${hash}
        -->
        </div>
