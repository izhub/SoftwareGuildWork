        ...
        <div class="container">
            ...
            <div class="navbar">
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation"class="active"> <a href="${pageContext.request.contextPath}/TipCalculator/displayTippingCalc">Tipping Calculator</a></li>
                ...
                <h2>Find the Total Amount</h2><p>
                    <br>
            <p>Amount: $ ${value} </p>
            <p>Tip Percentage: ${tipPer} % </p>
           <p> Tip Amount: $ ${tip} </p>
           <p><b>Total: $ ${total} </b></p>
        </div>
