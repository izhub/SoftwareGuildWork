...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div class="navbar">
                <ul class="nav nav-tabs">
                    ...
                    <!--Log out Link - springmvctutorial step18_incorporatingSpringSecurity--> 
                    <li role="presentation">
                        <a href="${pageContext.request.contextPath}/j_spring_security_logout">Log out</a>
                        <!--prints out name of your view page-->
                        <!--change name of application - in webpages/META_INF/context.xml--> 
                    </li>
                </ul>    
            </div>         
        </div>
        ...
        <div class="container">
            <h1>Company Contacts</h1>
            <!--#2 Personalized welcome msg - step18_incorporatingSpringSecurity-->
            Hello <sec:authentication property="principal.username" />!<br>

            <!-- #1 - Link to addContactForm -->
            <!--#3 render link - step18_incorporatingSpringSecurity-->
