...
import com.swcguild.contactlist.dao.SearchTerm;
 ...
 * @author apprentice
 */
public class ContactListDbImpl implements ContactListDao{
//highly recommend red/green test at this stage
    ...
    private static final String SQL_UPDATE_CONTACT =
            "update contacts set first_name=?, last_name=?, company=?, phone=?,"
            + "email=? where contact_id=?";
    
    private JdbcTemplate jdbcTemplate;
    
//    public ContactListDbImpl(JdbcTemplate jdcTemplate){
//    
//        this.jdbcTemplate= jdcTemplate;        
//    }
//    
    //doing it the setters injection way vs constructor 
    ...
    public Contact getContactById(int contactId) {
     try{  return jdbcTemplate.queryForObject(SQL_SELECT_CONTACT, new ContactMapper(), contactId);
    ...
    public List<Contact> searchContacts(Map<SearchTerm, String> criteria) {
        if (criteria.size() == 0){
            ...
            //get params and start building // doing this way to avoid hacking
