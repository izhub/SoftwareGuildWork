...
// exist in java 1.8; keep in mind for capstone; means your time zone
    ...
    public long getServerAge(){
        //local date can calc different time periods
        //whatever date you put in, can calc from date to another date, including 'now'
        //docs show more info, such Period         
    ...
    public int hashCode() {
        ...
        hash = 59 * hash + Objects.hashCode(this.ram);
        hash = 59 * hash + this.numProcessors;
